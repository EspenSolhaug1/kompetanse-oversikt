...
import { QuizQuestion } from "../../types/QuizTest";
...
const QuizComponent: React.FC = () => {
    ...
    const [userAnswers, setUserAnswers] = useState<{ selected: string; correct: string }[]>([]);
            ...
            <ul>
              {quiz.map((question, index) => (
                <li key={index}>
                  ...
                  <p>
                    <strong>Your Answer:</strong> {question.options[userAnswers[index].selected]}{" "}
